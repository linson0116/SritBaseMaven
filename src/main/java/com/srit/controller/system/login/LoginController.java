package com.srit.controller.system.login;
...
import com.srit.controller.base.BaseController;
import com.srit.entity.system.Menu;
import com.srit.entity.system.Role;
import com.srit.entity.system.User;
import com.srit.service.system.menu.MenuService;
import com.srit.service.system.role.RoleService;
import com.srit.service.system.user.UserService;
import com.srit.util.AppUtil;
import com.srit.util.Const;
import com.srit.util.DateUtil;
import com.srit.util.PageData;
import com.srit.util.RightsHelper;
import com.srit.util.Tools;
/*
 * 总入口
 */
@Controller
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("srit", "").replaceAll("srit", "").split(",fh,");
		...
		if(null != KEYDATA && KEYDATA.length == 3){
			...
			if(null == code || "".equals(code)){
				...
				if(Tools.notEmpty(sessionCode) && sessionCode.equalsIgnoreCase(code)){
					...
					//String passwd ="de41b7fb99201d8334c23c014db35ecd92df81bc";
					...
					if(pd != null){
						...
						//user.setPASSWORD("de41b7fb99201d8334c23c014db35ecd92df81bc");
