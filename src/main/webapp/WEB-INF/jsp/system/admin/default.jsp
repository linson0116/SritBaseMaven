	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				<div class="container">
                <div class="row">
                    <div class="span6" id="chart1" style="background: rgba(255,149,67,0.64);height: 300px">
                        <jsp:include page="../../echartstemplate/echarts_template.jsp"></jsp:include>
                    </div>
                    <div class="span6" id="chart2" style="background: rgba(255,149,67,0.64);height: 300px">
                        <jsp:include page="../../echartstemplate/echarts_template.jsp"></jsp:include>
                    </div>
                </div>
                <div class="row">
                    <div class="span6">图表</div>
                    <div class="span6">图表</div>
                </div>
            </div>
			</div>
