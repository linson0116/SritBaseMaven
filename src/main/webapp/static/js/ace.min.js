...
/*
 * //判断菜单缩放 var hasMenu = true; var strCookie=document.cookie; var
 * arrCookie=strCookie.split(";"); for(var i=0;i<arrCookie.length;i++){ var
 * arr=arrCookie[i].split("="); if("hasMenu"==arr[0]){ hasMenu=arr[1];
 * //alert(hasMenu); break; } }
 * 
